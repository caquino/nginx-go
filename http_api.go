...
type HTTPApiService service


/* HTTPApiService Return list of HTTP-related endpoints
 Returns a list of first level HTTP endpoints.
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @return ArrayOfStrings*/
func (a *HTTPApiService) GetHttp(ctx context.Context) (ArrayOfStrings,  *http.Response, error) {
	var (
