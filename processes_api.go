...
/* ProcessesApiService Reset nginx processes statistics
 Resets counters of abnormally terminated and respawned child processes.
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @return */
func (a *ProcessesApiService) DeleteProcesses(ctx context.Context) ( *http.Response, error) {
	var (
...
/* ProcessesApiService Return nginx processes status
 Returns the number of abnormally terminated and respawned child processes.
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @return NginxProcesses*/
func (a *ProcessesApiService) GetProcesses(ctx context.Context) (NginxProcesses,  *http.Response, error) {
	var (
