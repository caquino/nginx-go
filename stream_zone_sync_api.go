...
type StreamZoneSyncApiService service


/* StreamZoneSyncApiService Return sync status of a node
 Returns synchronization status of a cluster node.
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @return NginxStreamZoneSync*/
func (a *StreamZoneSyncApiService) GetStreamZoneSync(ctx context.Context) (NginxStreamZoneSync,  *http.Response, error) {
	var (
