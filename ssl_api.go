...
/* SSLApiService Reset SSL statistics
 Resets counters of SSL handshakes and session reuses.
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @return */
func (a *SSLApiService) DeleteSslStat(ctx context.Context) ( *http.Response, error) {
	var (
...
/* SSLApiService Return SSL statistics
...
func (a *SSLApiService) GetSsl(ctx context.Context, localVarOptionals map[string]interface{}) (NginxSslObject,  *http.Response, error) {
	var (
