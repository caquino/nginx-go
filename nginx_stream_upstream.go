...
type NginxStreamUpstream struct {

	Peers *NginxStreamUpstreamPeerMap `json:"peers,omitempty"`
	...
	// The name of the shared memory <a href=\"https://nginx.org/en/docs/stream/ngx_stream_upstream_module.html#zone\">zone</a> that keeps the group’s configuration and run-time state.
