...
/* StreamApiService Return list of stream-related endpoints
 Returns a list of first level stream endpoints.
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @return ArrayOfStrings*/
func (a *StreamApiService) GetStream(ctx context.Context) (ArrayOfStrings,  *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/stream/"
