...
// Status information for all stream <a href=\"https://nginx.org/en/docs/http/ngx_http_status_module.html#status_zone\">status zones</a>. 
type NginxStreamServerZonesMap struct {
}
