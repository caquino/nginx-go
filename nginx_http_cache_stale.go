...
type NginxHttpCacheStale struct {

	// The total number of expired responses read from the cache (see <a href=\"https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_cache_use_stale\">proxy_cache_use_stale</a> and other “<code>*_cache_use_stale</code>” directives).
