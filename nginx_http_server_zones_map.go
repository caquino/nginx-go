...
// Status data for all HTTP <a href=\"https://nginx.org/en/docs/http/ngx_http_status_module.html#status_zone\">status zones</a>. 
type NginxHttpServerZonesMap struct {
}
